...
const Header = () => {
  return (
    <div className='flex items-center justify-between flex-col-reverse sm:flex-row gap-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      {/*--------Left Side----------*/}
      <div>
        ...
        <div>
          ...
          <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700' htmlFor='upload1'>
            <img className='w-8' src={assets.upload_btn_icon} alt='' />
